    ...
    <div class="modal-dialog">
      <div class="modal-content login-modal">
        <div class="modal-header login-modal-header">
          ...
          <h4 class="modal-title text-center" id="loginModalLabel">Login to view the new order</h4>
        </div>
                  ...
                  <form>
                    ...
                    <div class="login-modal-footer">
                      <div class="row">
						...
						<img src="assets/img/logo.png" alt="DropBox" style="width:230px;height:50px;">
